...
public class GroupsPage {
	...
	@FindBy(how = How.XPATH, using = "//*[contains(text(),' Disabling forum will remove all the discussion. Do you want to continue ?')]")
	private WebElement disableDiscussionPopupMessages;
...
Thread.sleep(3000);
	...
	public void disableDiscussion() {
		UtilityFunctions.waitForElementAndClickable(disableDiscussion);
		Listeners.addLogs("click on disableDiscussion");
	}

	public void disableDiscussionsInPopup() {
		UtilityFunctions.waitForElementAndClickable(disableDisussionInPopup);
		Listeners.addLogs("click on disableDisussionInPopup");
	}

	public String assertDisableDiscussionToastr() {
		UtilityFunctions.waitForVisibilityOfWebElement(assertDisableDiscussionToastrMsg);
		String actualText = UtilityFunctions.getTextFromElement(assertDisableDiscussionToastrMsg);
		Listeners.addLogs("assertDisableDiscussionToastrMsg validated");
		UtilityFunctions.waitForElementToDisappear(assertDisableDiscussionToastrMsg);
		return actualText;

	}
	public void assertMessagesinDisableDiscussionPopup() {
		UtilityFunctions.validatIsElementPresent(disableDiscussionPopupMessages,"Message not displayed in disableDiscussion popup");
		Listeners.addLogs("validated messages in disableDiscussionPopupMessages ");
	}
}